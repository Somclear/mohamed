...
Class MetForm_Input_File_Upload extends Widget_base{
	...
	function get_max_upload_size() {
		$max_upload_size = wp_max_upload_size(); // Get the maximum upload size in bytes
	
		// Convert the size to a human-readable format
		$max_upload_size_human = size_format($max_upload_size, 2);
	
		return $max_upload_size_human;
	}
