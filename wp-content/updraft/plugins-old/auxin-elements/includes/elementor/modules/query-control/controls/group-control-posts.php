...
class Group_Control_Posts extends Group_Control_Base {
	...
	public static function on_export_remove_setting_from_element( $element, $control_id ) {
		...
		foreach ( auxin_get_public_post_types() as $post_type => $label ) {
	...
	protected function prepare_fields( $fields ) {
		...
		$post_types_options['by_id'] = __( 'Manual Selection', 'auxin-elements' );
		$post_types_options['current_query'] = __( 'Current Query', 'auxin-elements' );
	...
	public function get_query_args( $control_id_prefix, $settings ) {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'auxin/core_elements/query_control/get_query_args/current_query', $current_query_vars );
