...
class Gallery extends Widget_Base {
    ...
    */
    protected function render() {
        ...
        $tablet_columns = !empty( $settings['columns_tablet'] ) ? $settings['columns_tablet'] : 2;
        $mobile_columns = !empty( $settings['columns_mobile'] ) ? $settings['columns_mobile'] : 1;
        ...
        $args = array(
            ...
            'tablet_cnum'        => $tablet_columns,
            'phone_cnum'         => $mobile_columns,
